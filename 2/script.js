...
const Feature = props => (
  <div className="features-slider_item">
		<div className="features-img" style= {{backgroundImage: `url(./images/${props.index}.svg)`}}></div>
		<div className="features-feature">{props.count} целевое преимущество</div>
	</div>
)
			...
			<div className="features-wrapper">
				...
				<div className="features-slider">
					<div className="features-slider_items">
						<Feature index = '1' count ='Первое'/>
            <Feature index = '2' count ='Второе'/>
            <Feature index = '3' count ='Третье'/>
            <Feature index = '4' count ='Четвертое'/>
					</div>
